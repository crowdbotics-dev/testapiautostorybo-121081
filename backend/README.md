...
## Project Structure
    ...
    ├── testapiautostorybo_121081  # Django project configurations
...
1. Clone this repo and `cd testapiautostorybo_121081`
...
2. Clone this repo and `cd testapiautostorybo_121081`
